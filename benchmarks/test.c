...
int main()
{
    ...
    FILE *fp_in = fopen("output/benchmark_inputsize_opt3", "w");
    ...
    FILE *fp_bs = fopen("output/benchmark_blocksize_opt3", "w");
    ...
    FILE *fp_nb = fopen("output/benchmark_numblocks_opt3", "w");
