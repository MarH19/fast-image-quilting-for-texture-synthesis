            ...
            for (int icol = 0; icol < error_width - 15; icol += 16)
            {
                ...
                for (int k = 0; k < overlap; k++)
                {
                    for (int m = 0; m < overlap * 3; m += 8)
                    {
                        ...
                        //------------------
                        __m256i m00_in_2 = _mm256_loadu_si256(&in[(irow + k) * ijump + (icol + blocksize - overlap + 0) * 3 + m]);
                        __m256i m01_in_2 = _mm256_loadu_si256(&in[(irow + k) * ijump + (icol + blocksize - overlap + 1) * 3 + m]);
                        __m256i m02_in_2 = _mm256_loadu_si256(&in[(irow + k) * ijump + (icol + blocksize - overlap + 2) * 3 + m]);
                        __m256i m03_in_2 = _mm256_loadu_si256(&in[(irow + k) * ijump + (icol + blocksize - overlap + 3) * 3 + m]);
                        __m256i m04_in_2 = _mm256_loadu_si256(&in[(irow + k) * ijump + (icol + blocksize - overlap + 4) * 3 + m]);
                        __m256i m05_in_2 = _mm256_loadu_si256(&in[(irow + k) * ijump + (icol + blocksize - overlap + 5) * 3 + m]);
                        __m256i m06_in_2 = _mm256_loadu_si256(&in[(irow + k) * ijump + (icol + blocksize - overlap + 6) * 3 + m]);
                        __m256i m07_in_2 = _mm256_loadu_si256(&in[(irow + k) * ijump + (icol + blocksize - overlap + 7) * 3 + m]);
                        __m256i m08_in_2 = _mm256_loadu_si256(&in[(irow + k) * ijump + (icol + blocksize - overlap + 8) * 3 + m]);
                        __m256i m09_in_2 = _mm256_loadu_si256(&in[(irow + k) * ijump + (icol + blocksize - overlap + 9) * 3 + m]);
                        __m256i m10_in_2 = _mm256_loadu_si256(&in[(irow + k) * ijump + (icol + blocksize - overlap + 10) * 3 + m]);
                        __m256i m11_in_2 = _mm256_loadu_si256(&in[(irow + k) * ijump + (icol + blocksize - overlap + 11) * 3 + m]);
                        __m256i m12_in_2 = _mm256_loadu_si256(&in[(irow + k) * ijump + (icol + blocksize - overlap + 12) * 3 + m]);
                        __m256i m13_in_2 = _mm256_loadu_si256(&in[(irow + k) * ijump + (icol + blocksize - overlap + 13) * 3 + m]);
                        __m256i m14_in_2 = _mm256_loadu_si256(&in[(irow + k) * ijump + (icol + blocksize - overlap + 14) * 3 + m]);
                        __m256i m15_in_2 = _mm256_loadu_si256(&in[(irow + k) * ijump + (icol + blocksize - overlap + 15) * 3 + m]);
                        __m256i m_out_2 = _mm256_loadu_si256(&out[(orow + k) * ojump + (ocol + blocksize - overlap) * 3 + m]);
