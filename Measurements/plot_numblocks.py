...
ax.plot(opt1['numblocks'],opt1['seconds'],marker='^', linewidth=2, color="dimgray", label='Optimization 1')

ax.plot(opt2['numblocks'],opt2['seconds'], marker='o', linewidth=2, color="darkred", label='Optimization 2')

ax.plot(opt3['numblocks'],opt3['seconds'], marker='8', linewidth=2, color="darkgreen", label='Optimization 3')
