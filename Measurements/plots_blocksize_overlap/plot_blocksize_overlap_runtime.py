...
ax.plot(n,base_O3['seconds'],marker='s', markersize=12, linewidth=4, color="#1E90FF", label='Base -O3 -mfma')
#ax.plot(n,base_O3_fastmath['seconds'],marker='s', markersize=12, linewidth=4, color="#0000FF", label='Base -O3 -mfma -ffast-math -march=native')

#Optimization 1
#ax.plot(n,opt1_O3_novec['seconds'],marker='s', markersize=12, linewidth=4, color="#FFA07A", label='Opt1 -O3 -mfma -fno-tree-vectorize -fno-slp-vectorize')
ax.plot(n,opt1_O3['seconds'],marker='s', markersize=12, linewidth=4, color="#FF4500", label='Opt1 -O3 -mfma')
#ax.plot(n,opt1_O3_fastmath['seconds'],marker='s', markersize=12, linewidth=4, color="#FF0000", label='Opt1 -O3 -mfma -ffast-math -march=native')

#Optimization 2
#ax.plot(n,opt2_O3_novec['seconds'],marker='s', markersize=12, linewidth=4, color="#7CFC00", label='Opt2 -O3 -mfma -fno-tree-vectorize -fno-slp-vectorize')
ax.plot(n,opt2_O3['seconds'],marker='s', markersize=12, linewidth=4, color="#00A36C", label='Opt2 -O3 -mfma')
#ax.plot(n,opt2_O3_fastmath['seconds'],marker='s', markersize=12, linewidth=4, color="#355E3B", label='Opt2 -O3 -mfma -ffast-math -march=native')

#Optimization 3
#ax.plot(n,opt3_O3_novec['seconds'],marker='s', markersize=12, linewidth=4, color="#DA70D6", label='Opt3 -O3 -mfma -fno-tree-vectorize -fno-slp-vectorize')
ax.plot(n,opt3_O3['seconds'],marker='s', markersize=12, linewidth=4, color="#8A2BE2", label='Opt3 -O3 -mfma')
#ax.plot(n,opt3_O3_fastmath['seconds'],marker='s', markersize=12, linewidth=4, color="#800080", label='Opt3 -O3 -mfma -ffast-math -march=native')
...
plt.savefig('generated_plots/plot_blocksize_overlap_runtime.pdf', bbox_inches='tight')
plt.show()
